...
{
    public class CustomerViewModel : WorkspaceViewModel, IViewModel, IDataErrorInfo
    {
        #region Fields
        ...
        public CustomerViewModel(Customer customer, CustomerRepository customerRepository)
        {
            ...
            _customerType = Resources.CustomerViewModel_CustomerTypeOption_NotSpecified;
        }
        ...
        public string CustomerType
        {
            ...
            set
            {
                ...
                if (_customerType == Resources.CustomerViewModel_CustomerTypeOption_Company)
                {
                    _customer.IsCompany = true;
                }
                else if (_customerType == Resources.CustomerViewModel_CustomerTypeOption_Person)
                {
        ...
        {
            if (this.CustomerType == Resources.CustomerViewModel_CustomerTypeOption_Company ||
               this.CustomerType == Resources.CustomerViewModel_CustomerTypeOption_Person)
                return null;

            return Resources.CustomerViewModel_Error_MissingCustomerType;
        }
